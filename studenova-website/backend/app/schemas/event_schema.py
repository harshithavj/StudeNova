...
class EventCreateSchema(ma.Schema):
    ...
    domain = fields.String(load_default=None, allow_none=True)
    ...
    conducting_organization = fields.String(load_default=None, allow_none=True)
    eligibility = fields.String(load_default=None)
    team_size = fields.String(load_default=None, allow_none=True)
    prize_pool = fields.Decimal(load_default=0, as_string=True)
    rules = fields.String(load_default=None, allow_none=True)
    schedule = fields.List(fields.Dict(), load_default=[])
    contact_email = fields.Email(load_default=None, allow_none=True)
    faqs = fields.List(fields.Dict(), load_default=[])
